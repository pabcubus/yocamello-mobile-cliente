						...
						.then(function(servicios){
							...
							setTimeout(() => {
								...
								vm.servicios.forEach(servicio => {
									servicio.mapUrl = `https://maps.googleapis.com/maps/api/staticmap?&zoom=15&size=${card.offsetWidth}x150&maptype=roadmap&markers=color:red%7Clabel:F%7C${servicio.lat},${servicio.lng}&key=AIzaSyDQ-rRq16rEIUX7-dOk5UBM0eEIwJEGDTk`;
								});
							}, 200);
